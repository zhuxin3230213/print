...
namespace SoftPOS
{
    public class PrinterHelper
    {
        ...
        public static String getStatusl(String printer_name)
        {
            String str = "";
            string path = @"win32_printer.DeviceId='" + printer_name + "'";
            ManagementObject printer = new ManagementObject(path);
            ...
            while (pde.MoveNext())
            {
                str += pde.Current.Name + " : " + pde.Current.Value + "\r\n";
                //显示的是 属性名 : 属性值 的形式
        ...
        static void Main()
        {
            Console.WriteLine("打印机"+PrinterHelper.GetDeaultPrinterName());
            Console.WriteLine("打印机状态"+PrinterHelper.GetPrinterStatus(PrinterHelper.GetDeaultPrinterName()));
            Console.WriteLine("打印机状态"+PrinterHelper.getStatus(PrinterHelper.GetDeaultPrinterName()));

            PrinterS printerS = new PrinterS(PrinterHelper.GetDeaultPrinterName());
            Console.WriteLine("打印机状态"+printerS.getStatus());

            Console.WriteLine("打印机" + PrinterHelper.getStatusl(PrinterHelper.GetDeaultPrinterName()));
